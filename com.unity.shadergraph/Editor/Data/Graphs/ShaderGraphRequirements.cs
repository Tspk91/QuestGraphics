...
namespace UnityEditor.ShaderGraph.Internal
{
    ...
    public struct ShaderGraphRequirements
    {
            ...
            where T : AbstractMaterialNode
        {
            ...
            bool requiresVertexColor = true; //nodes.OfType<IMayRequireVertexColor>().Any(x => x.RequiresVertexColor()); // (ASG): All shaders use vertex colors, because we allow vertex coloring for painting.
